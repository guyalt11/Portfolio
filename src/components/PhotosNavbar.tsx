...
const Navbar = () => {
  ...
  const menuItems = [
    { path: "/photos?category=People", label: "People" },
    { path: "/photos?category=Urban", label: "Urban" },
    { path: "/photos?category=Nature", label: "Nature" },
    { path: "/photos?category=B%26W", label: "B&W" },
    { path: "/photos?category=Textures", label: "Textures" },
  ];
